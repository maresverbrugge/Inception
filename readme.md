In this project, I learned how to set up a secure NGINX server, a dynamic WordPress site, and a resilient MariaDB database, all interconnected through Docker Compose.
